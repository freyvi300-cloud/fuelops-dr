      ...
      <div className="bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-700/50 px-4 sm:px-6 py-4 shrink-0"
        ...
        <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-slate-100 tracking-tight">Camiones / Equipos</h1>
            <p className="text-xs font-sans text-slate-400 mt-0.5">
              Gestiona los vehículos y equipos asociados a tus clientes.
            </p>
          </div>

          {/* Icons group: always stays on same row as title */}
