  ...
  return (
    <header className="h-16 bg-white border-b border-slate-100 flex items-center px-6 gap-4 shrink-0 shadow-sm">
      ...
      <div className="flex-1 min-w-0">
        <h1 className="text-base font-semibold text-slate-800 leading-tight">¡Buenos días, Administrador!</h1>
        <p className="text-xs text-slate-400 leading-tight">Aquí tienes el resumen general de tu negocio.</p>
      </div>
      ...
      <div className="relative hidden lg:block">
        ...
        <input
          ...
          className="pl-9 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-600 placeholder:text-slate-400 w-72 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 transition-all"
        />
      </div>
